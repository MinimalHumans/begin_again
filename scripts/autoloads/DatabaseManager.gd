...
func _seed_tier2_events() -> void:
	_library_db.query("SELECT COUNT(*) AS cnt FROM events WHERE tier = 2;")
	if _library_db.query_result.size() > 0 and int(_library_db.query_result[0].get("cnt", 0)) >= 26:
		return
	...
	_insert_tier2_event("tier2_rule_proposal", "Rule Proposal", "governance", "{}", a1, 18, 1.0, null, 1,
	...
	_insert_tier2_event("tier2_religious_gathering", "Religious Gathering", "social", "{}", a1, 18, 1.0, null, 1,
	...
	_insert_tier2_event("tier2_morale_speech", "Morale Crisis", "social", '{"stat_below":{"morale":35}}', null, 20, 1.0, null, 1,
	...
	_insert_tier2_event("tier2_leadership_question", "Leadership Question", "governance", "{}", a1, 25, 1.0, null, 1,
	...
	# Event 21: Delegate Day-to-Day
	_insert_tier2_event("tier2_delegate_duties", "Delegate Day-to-Day", "governance", '{"min_game_day":30,"max_game_day":180}', a1, 0, 1.0, null, 1,
		'{actor_1} has been quietly managing things behind the scenes. They ask if you want to formalise it — let them handle the minor day-to-day decisions so you can focus on bigger things.',
		'[{"id":"a","text_template":"Yes. Handle the small stuff.","immediate_effects":{},"community_scores":{"commonwealth":2,"archive":1},"roll":{"relevant_stats":[{"stat":"stability","weight":1.0}],"base_value":0.3,"context_bonuses":[]},"outcomes":{"bad":{"text":"{actor_1} overreached. Small decisions became big ones without you noticing.","effects":{"stability":-5,"cohesion":-3},"flags_set":["duties_delegated"],"flags_cleared":[]},"mixed":{"text":"A small stability bump. {actor_1} handles the routine. You handle the rest.","effects":{"stability":4},"flags_set":["duties_delegated"],"flags_cleared":[]},"good":{"text":"The delegation worked. {actor_1} proved capable and the community runs smoother.","effects":{"stability":8,"morale":3},"flags_set":["duties_delegated"],"flags_cleared":[]}}},{"id":"b","text_template":"No. I make all decisions.","immediate_effects":{"stability":2},"community_scores":{"throne":3},"roll":{"relevant_stats":[],"base_value":0.5,"context_bonuses":[]},"outcomes":{"good":{"text":"The community knows where authority lies.","effects":{"stability":5},"flags_set":[],"flags_cleared":[]}}}]'
	)

	# Event 22: Emergency Scavenging (resources critical)
	_insert_tier2_event("tier2_emergency_scavenge", "Emergency Run", "resource", '{"required_state_tags":["resources_critical"]}', a1, 10, 1.0, null, null,
		'Supplies are nearly gone. Something needs to happen now. {actor_1} says they know a place worth trying.',
		'[{"id":"a","text_template":"Send {actor_1} alone. Quick and quiet.","immediate_effects":{},"community_scores":{"exchange":2,"rewilded":1},"roll":{"relevant_stats":[{"stat":"security","weight":0.8},{"stat":"knowledge","weight":0.5}],"base_value":0.1,"context_bonuses":[{"condition":"actor_has_skill:combat","bonus":0.3}]},"outcomes":{"bad":{"text":"{actor_1} came back empty-handed and injured. The place was picked clean.","effects":{"health":-5,"morale":-4},"flags_set":["actor_1:injured"],"flags_cleared":[]},"mixed":{"text":"{actor_1} found enough to buy time. Not much, but something.","effects":{"resources":10},"flags_set":[],"flags_cleared":[]},"good":{"text":"{actor_1} hit a cache nobody else had found. Significant supplies recovered.","effects":{"resources":22,"morale":4},"flags_set":[],"flags_cleared":[]}}},{"id":"b","text_template":"Send a team. Better odds, higher cost.","immediate_effects":{"security":-3},"community_scores":{"bastion":2,"commonwealth":1},"roll":{"relevant_stats":[{"stat":"security","weight":0.6},{"stat":"resources","weight":0.5}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"The team drew attention and came back with barely anything. Security is worse.","effects":{"security":-5,"morale":-3},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"A decent haul. The team came back tired but intact.","effects":{"resources":15},"flags_set":[],"flags_cleared":[]},"good":{"text":"The team cleared the area efficiently. A real recovery.","effects":{"resources":25,"morale":5,"security":3},"flags_set":[],"flags_cleared":[]}}},{"id":"c","text_template":"Wait and ration what remains.","immediate_effects":{"morale":-3},"community_scores":{"archive":1,"rewilded":1},"roll":{"relevant_stats":[{"stat":"stability","weight":0.8},{"stat":"cohesion","weight":0.4}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"Rationing led to arguments. People are hungry and angry.","effects":{"morale":-6,"cohesion":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"The rationing held. Barely. People are unhappy but alive.","effects":{"morale":-2},"flags_set":[],"flags_cleared":[]},"good":{"text":"Discipline held. The community pulled together and made it work.","effects":{"stability":4,"cohesion":3},"flags_set":[],"flags_cleared":[]}}}]'
	)

	# Event 23: Medical Crisis Response (health critical)
	_insert_tier2_event("tier2_medical_crisis", "Medical Emergency Response", "health", '{"required_state_tags":["health_critical"]}', null, 10, 1.0, null, null,
		'People are getting seriously ill and the situation is deteriorating. Something needs to be done now.',
		'[{"id":"a","text_template":"Use remaining supplies aggressively. Treat everyone.","immediate_effects":{"resources":-15},"community_scores":{"commonwealth":2,"congregation":1},"roll":{"relevant_stats":[{"stat":"health","weight":1.0},{"stat":"knowledge","weight":0.4}],"base_value":0.1,"context_bonuses":[{"condition":"stat_above:resources:30","bonus":0.2}]},"outcomes":{"bad":{"text":"Supplies depleted and no improvement. The illness is resistant to what you had.","effects":{"health":-5,"morale":-5},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"The worst cases stabilised. Not a cure, but the bleeding stopped.","effects":{"health":8},"flags_set":[],"flags_cleared":[]},"good":{"text":"Aggressive treatment worked. People are recovering. The community breathes again.","effects":{"health":15,"morale":6},"flags_set":[],"flags_cleared":[]}}},{"id":"b","text_template":"Call for volunteer caregivers. Compassion over medicine.","immediate_effects":{},"community_scores":{"kindred":3,"congregation":1},"roll":{"relevant_stats":[{"stat":"morale","weight":0.8},{"stat":"cohesion","weight":0.6}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"Nobody stepped up. The sick felt abandoned.","effects":{"morale":-6,"cohesion":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"A few volunteers helped. Spirits lifted slightly even if the illness persists.","effects":{"morale":3,"health":4},"flags_set":[],"flags_cleared":[]},"good":{"text":"The community rallied. People took shifts caring for the sick. Recovery followed.","effects":{"health":10,"morale":5,"cohesion":4},"flags_set":[],"flags_cleared":[]}}},{"id":"c","text_template":"Send someone to find medical supplies outside.","immediate_effects":{},"community_scores":{"exchange":2,"archive":1},"roll":{"relevant_stats":[{"stat":"security","weight":0.8},{"stat":"knowledge","weight":0.5}],"base_value":0.1,"context_bonuses":[{"condition":"flag:outside_contact_made","bonus":0.3}]},"outcomes":{"bad":{"text":"The search party found nothing and came back exposed to worse conditions.","effects":{"health":-8,"security":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"Some basic supplies found. Enough to help but not enough to solve the problem.","effects":{"health":6,"resources":5},"flags_set":[],"flags_cleared":[]},"good":{"text":"A medical cache was found intact. Antibiotics, bandages, real supplies.","effects":{"health":18,"resources":10,"morale":5},"flags_set":[],"flags_cleared":[]}}}]'
	)

	# Event 24: Forage for Food (food critical)
	_insert_tier2_event("tier2_forage_critical", "Finding Food", "resource", '{"required_state_tags":["food_critical"]}', a1, 7, 1.0, null, null,
		'Food is nearly gone. {actor_1} is asking permission to take a team and search the surrounding area. The risk is real but so is the alternative.',
		'[{"id":"a","text_template":"Send {actor_1} with a team. Find something.","immediate_effects":{},"community_scores":{"exchange":2,"bastion":1},"roll":{"relevant_stats":[{"stat":"security","weight":0.7},{"stat":"knowledge","weight":0.5}],"base_value":0.1,"context_bonuses":[{"condition":"season:summer","bonus":0.2}]},"outcomes":{"bad":{"text":"The team came back with nothing. Two days lost and morale is shattered.","effects":{"morale":-6,"security":-3},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"Enough for a few days. Not a solution, but time bought.","effects":{"food":12},"flags_set":[],"flags_cleared":[]},"good":{"text":"A significant find. Preserved food, edible plants, enough to stabilise.","effects":{"food":25,"morale":5},"flags_set":[],"flags_cleared":[]}}},{"id":"b","text_template":"Strip nearby houses for anything edible.","immediate_effects":{},"community_scores":{"rewilded":2,"archive":1},"roll":{"relevant_stats":[{"stat":"knowledge","weight":0.8}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"The houses were empty. A wasted effort.","effects":{"morale":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"A few cans, some dried goods. Better than nothing.","effects":{"food":8},"flags_set":[],"flags_cleared":[]},"good":{"text":"A pantry nobody had checked. Enough food to ease the immediate crisis.","effects":{"food":18,"morale":3},"flags_set":[],"flags_cleared":[]}}},{"id":"c","text_template":"Appeal to anyone nearby. Ask for help.","immediate_effects":{},"community_scores":{"commonwealth":2,"exchange":1},"roll":{"relevant_stats":[{"stat":"reputation","weight":1.0}],"base_value":0.0,"context_bonuses":[{"condition":"flag:outside_contact_made","bonus":0.4},{"condition":"stat_above:reputation:50","bonus":0.2}]},"outcomes":{"bad":{"text":"Nobody answered. Or nobody is out there.","effects":{"morale":-5},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"A small donation from a passing group. Charity, not trade.","effects":{"food":10,"reputation":-3},"flags_set":[],"flags_cleared":[]},"good":{"text":"A neighbouring group sent supplies. The beginning of a real relationship.","effects":{"food":20,"reputation":6,"morale":4},"flags_set":["outside_contact_made"],"flags_cleared":[]}}}]'
	)

	# Event 25: Security Breakdown (security critical)
	_insert_tier2_event("tier2_security_breakdown", "The Watch is Failing", "security", '{"required_state_tags":["security_critical"]}', a1, 12, 1.0, null, null,
		'The perimeter is barely being watched. {actor_1} came to you about it — people are scared and the watch rotation has collapsed.',
		'[{"id":"a","text_template":"Mandatory watch rotation. Everyone takes a shift.","immediate_effects":{"morale":-3},"community_scores":{"bastion":3,"throne":1},"roll":{"relevant_stats":[{"stat":"stability","weight":0.8},{"stat":"cohesion","weight":0.4}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"The mandatory rotation bred resentment. People are doing the bare minimum.","effects":{"morale":-5,"cohesion":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"The rotation is holding. People are tired but the perimeter is watched.","effects":{"security":8,"morale":-2},"flags_set":[],"flags_cleared":[]},"good":{"text":"The structure gave people purpose. Security improved and the fear eased.","effects":{"security":14,"stability":4,"morale":2},"flags_set":[],"flags_cleared":[]}}},{"id":"b","text_template":"Ask for volunteers. Let people step up.","immediate_effects":{},"community_scores":{"commonwealth":2,"kindred":1},"roll":{"relevant_stats":[{"stat":"morale","weight":0.7},{"stat":"cohesion","weight":0.6}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"Nobody volunteered. The silence was worse than the threat.","effects":{"morale":-6,"security":-3,"cohesion":-4},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"A few people stepped up. Not enough, but a start.","effects":{"security":6,"cohesion":3},"flags_set":[],"flags_cleared":[]},"good":{"text":"People responded. A genuine community watch emerged from choice, not obligation.","effects":{"security":12,"morale":5,"cohesion":5},"flags_set":[],"flags_cleared":[]}}},{"id":"c","text_template":"Fortify physically instead. Walls instead of watchers.","immediate_effects":{"resources":-10},"community_scores":{"bastion":2,"archive":1},"roll":{"relevant_stats":[{"stat":"security","weight":0.6},{"stat":"resources","weight":0.5}],"base_value":0.3,"context_bonuses":[]},"outcomes":{"bad":{"text":"The fortifications used materials needed elsewhere and are not enough on their own.","effects":{"resources":-5,"morale":-3},"flags_set":[],"flags_cleared":[]},"mixed":{"text":"Better barriers help. Not a substitute for people, but something.","effects":{"security":8},"flags_set":[],"flags_cleared":[]},"good":{"text":"The physical improvements made a real difference. The settlement feels safer.","effects":{"security":14,"morale":4,"stability":3},"flags_set":[],"flags_cleared":[]}}}]'
	)

	# Event 26: Morale Rally (morale critical)
	_insert_tier2_event("tier2_morale_rally", "Something Has to Give", "social", '{"required_state_tags":["morale_critical"],"excluded_flags":["morale_speech_given"]}', null, 15, 1.0, null, null,
		'The community is breaking down. People are not sleeping. Work has slowed to almost nothing. You need to do something.',
		'[{"id":"a","text_template":"Speak directly and honestly about where things stand.","immediate_effects":{},"community_scores":{"commonwealth":3,"throne":1},"roll":{"relevant_stats":[{"stat":"cohesion","weight":0.8},{"stat":"stability","weight":0.5}],"base_value":0.2,"context_bonuses":[]},"outcomes":{"bad":{"text":"The honesty landed badly. People heard despair, not resolve.","effects":{"morale":-5,"cohesion":-3},"flags_set":["morale_speech_given"],"flags_cleared":[]},"mixed":{"text":"A temporary lift. Whether it lasts depends on what follows.","effects":{"morale":5},"flags_set":["morale_speech_given"],"flags_cleared":[]},"good":{"text":"The words found their mark. A genuine turning point. People reconnected with why they are here.","effects":{"morale":12,"cohesion":5},"flags_set":["morale_speech_given"],"flags_cleared":[]}}},{"id":"b","text_template":"Redistribute workload. Give everyone lighter duties for a week.","immediate_effects":{"resources":-5,"stability":-3},"community_scores":{"kindred":2,"commonwealth":1},"roll":{"relevant_stats":[{"stat":"morale","weight":0.8},{"stat":"stability","weight":0.4}],"base_value":0.3,"context_bonuses":[]},"outcomes":{"bad":{"text":"The lighter load felt like giving up. People got worse, not better.","effects":{"morale":-4,"stability":-3},"flags_set":["morale_speech_given"],"flags_cleared":[]},"mixed":{"text":"Some relief. People are functioning again, if barely.","effects":{"morale":6},"flags_set":["morale_speech_given"],"flags_cleared":[]},"good":{"text":"The breathing room was exactly what was needed. Energy returned.","effects":{"morale":10,"health":4},"flags_set":["morale_speech_given"],"flags_cleared":[]}}},{"id":"c","text_template":"Call a day of rest. Extra rations for everyone.","immediate_effects":{"food":-8},"community_scores":{"kindred":3,"congregation":1},"roll":{"relevant_stats":[{"stat":"morale","weight":1.0},{"stat":"cohesion","weight":0.5}],"base_value":0.3,"context_bonuses":[]},"outcomes":{"bad":{"text":"The rest day felt forced. People ate in silence.","effects":{"morale":-2},"flags_set":["morale_speech_given"],"flags_cleared":[]},"mixed":{"text":"A quiet day. Not a celebration, but people slept. That is something.","effects":{"morale":7,"health":3},"flags_set":["morale_speech_given"],"flags_cleared":[]},"good":{"text":"The day of rest broke something loose. People talked, laughed, remembered what this was for.","effects":{"morale":14,"cohesion":5,"health":3},"flags_set":["morale_speech_given","rest_day_called"],"flags_cleared":[]}}}]'
	)
...
func _seed_tier4_events() -> void:
	...
	_insert_tier4_event("tier4_childs_question", "What Was It Like?", "reflection", '{"required_state_tags":["recent_birth"],"min_game_day":912,"excluded_state_tags":["morale_critical","food_critical"]}', null, 1.0,
	...
	_insert_tier4_event("tier4_one_year", "One Year", "reflection", '{"min_game_day":365,"max_game_day":390,"excluded_state_tags":["food_critical","health_critical"]}', null, 1.0,
	...
	_insert_tier4_event("tier4_long_peace", "The Quiet Stretch", "reflection", '{"min_game_day":180,"required_state_tags":["security_good","morale_good"],"excluded_state_tags":["resources_critical","resources_low","health_critical","food_critical","morale_low","cohesion_low"]}', a1, 1.0,
